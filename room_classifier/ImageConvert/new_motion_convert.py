...
def convertAudioFiles(copy_flag=False):
    path = '/home/ascc/LF_Workspace/Bayes_model/IROS23/ADL_HMM_BAYES/Data_Apartment/ASCC_OFFLINE_0708_Final/Watch/Audio'
    count = 0
    dir = path
    for fn in os.listdir(path):
        if os.path.isdir(dir + '/' + fn):
            ...
            source_dir = dir + '/' + fn + '/*_rec.wav'

            new_dir = dir + '/' + fn + '/recorded.wav'
...
convertAudioFiles(copy_flag=True)