...
# True: train the data of all the data including transition, non-transition
# False: just train the transition data
TRAINING_FOR_ALL = True
...
def transition_feature_extractor(pre_motion_type, motion_type):
    ...
    if pre_motion_type != motion_type and (pre_motion_type == 'walking' or motion_type == 'walking'):
        ...
        tran = 2
    elif pre_motion_type != motion_type and (motion_type == 'standing'):
        tran = 3   
...
def adl_location_feature_extractor(location):
    ...
    output_matrix = to_categorical(class_vector, num_classes = rl_env_ascc_privacy.MAX_LOCATION_CLASS, dtype ="int32")
...
env = rl_env_ascc_privacy.EnvASCC(TEST_BASE_DATE + ' 00:00:00')
env.reset()
...
# new method, privacy(move robot usage to privacy part)
w_accuracy = 0.05
w_energy = 0.35
w_privacy = 0.6
...
w_accuracy = 0.05
w_energy = 0.35
w_privacy = 0.6 # increase the weight of privacy


# new method, privacy(move robot usage to privacy part)
# w_accuracy = 0.05
# w_energy = 0.6
# w_privacy = 0.35 # decrease the weight of privacy
...
def get_activity_prediction_by_time(time_str):
    ...
    d_act = datetime.strptime(time_str, rl_env_ascc_privacy.DATE_HOUR_TIME_FORMAT)
    ...
    while(True):
        ...
        new_time_str = new_time.strftime(rl_env_ascc_privacy.DATE_HOUR_TIME_FORMAT)
...
def trigger_times_normalization(times):
    n_t = times*1.0/rl_env_ascc_privacy.MAX_TRIGGER_TIMES
...
def construct_reward(action, ground_truth_act, location = ''):
    ...
    if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_WMU_vision \
        or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_fusion:
            
        reward_accuracy = 1

    elif rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_vision:
        ...
        if ground_truth_activity == 'Read' or ground_truth_activity == 'Desk_Activity' or ground_truth_activity == 'Kitchen_Activity':
            ...
            reward_accuracy = 0.1
    elif rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio:
        activity_rank_hit_times += 1
    ...
    if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Nothing:
        reward_accuracy = 0
    ...
    if motion_transition_occur_flag == True and reward_accuracy == 1:
        ...
        # reward = reward - (reward_privacy)*MOTION_TRANSITION_REWARD

        # reward = reward + MOTION_TRANSITION_REWARD
        #if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_fusion or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_WMU_fusion:
        #    reward = reward - (reward_energy+reward_privacy-reward_accuracy)*MOTION_TRANSITION_REWARD + MOTION_TRANSITION_REWARD
            #reward = reward - (reward_energy+reward_privacy-1)*MOTION_TRANSITION_REWARD
        #if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_vision:
        #    reward = reward - (reward_energy+reward_privacy-reward_accuracy)*MOTION_TRANSITION_REWARD + MOTION_TRANSITION_REWARD
            #reward = reward - (reward_energy+reward_privacy-1)*MOTION_TRANSITION_REWARD
    if sitting_motion_transition_occur_flag == True and reward_accuracy == 1:
        if location_type in rl_env_ascc_privacy.PRIVACY_LOCATION_LIST:
            if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_fusion or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_WMU_vision : 
                reward = reward + (1- reward_energy) *MOTION_TRANSITION_REWARD 
        else:
            reward = reward + (1- reward_privacy - reward_energy) *MOTION_TRANSITION_REWARD 

    if standing_motion_transition_occur_flag == True and reward_accuracy == 1:
        if location_type in rl_env_ascc_privacy.PRIVACY_LOCATION_LIST:
            if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_fusion or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_WMU_vision : 
                reward = reward + (1- reward_energy) *MOTION_TRANSITION_REWARD 
        else:
...
while(pre_activity == ''):
    ...
    audio_data, vision_data, motion_data, transition_motion = env.step(rl_env_ascc_privacy.WMU_FUSION_ACTION)

    # env.running_time
    # test_time_str = '2009-12-11 12:58:33'
    cur_time = env.get_running_time()
    cur_time_str = cur_time.strftime(rl_env_ascc_privacy.DATE_HOUR_TIME_FORMAT)
    print('cur_time:', cur_time)
    ...
    detected_activity = get_activity_by_action(cur_time_str, rl_env_ascc_privacy.WMU_FUSION_ACTION)
...
total_privacy_level1_times = []
total_privacy_level2_times = []
total_privacy_level1_robot_vision_times = []
total_privacy_level1_robot_sound_times = []
total_privacy_level1_wmu_sound_times = []
total_privacy_level2_robot_vision_times = []
total_privacy_level2_robot_sound_times = []
total_privacy_level2_wmu_sound_times = []
...
for episode in range(episode_count):
    ...
    sitting_motion_transition_occur_cnt = 0
    standing_motion_transition_occur_cnt = 0
    env.reset()
    while(pre_activity == ''):
        # open camera
    ...
    while(not env.done):
        ...
        ignore_time1 =  datetime.strptime('2009-12-11 18:53:00', rl_env_ascc_privacy.DATE_HOUR_TIME_FORMAT)
        ignore_time2 =  datetime.strptime('2009-12-11 20:36:40', rl_env_ascc_privacy.DATE_HOUR_TIME_FORMAT)
        ...
        # print("Env action: ", action, " ", rl_env_ascc_privacy.RL_ACTION_DICT[action])

        # env check the action and the cost time
        # action = 6 # rl_env_ascc_privacy.Robot_WMU_fusion # to get the time recognition dict
        env.step(action)
        ...
        reward_privacy = env.get_reward_privacy(action, ground_truth_activity, location_type, flag=True)
        ...
        # walking motion
        # TODO: only accucy == 1, then giving the transition reward
        motion_transition_occur_flag = False
        sitting_motion_transition_occur_flag = False
        standing_motion_transition_occur_flag = False
        if pre_motion_type != motion_type and (pre_motion_type == 'walking' or motion_type == 'walking'):
            print('activity:', pre_activity, ' ', ground_truth_activity)
            motion_transition_occur_cnt += 1
            print('activiy {} motion_transition_occur_cnt: {} p_activity {}'.format(cur_activity, motion_transition_occur_cnt, p_activity_end))
            motion_transition_occur_flag = True

        elif pre_motion_type != motion_type and (motion_type == 'sitting'):
            print('activity:', pre_activity, ' ', ground_truth_activity)
            sitting_motion_transition_occur_cnt += 1
            print('sitting_motion_transition_occur_cnt:', sitting_motion_transition_occur_cnt)
            sitting_motion_transition_occur_flag = True

        elif pre_motion_type != motion_type and (motion_type == 'standing'):
            print('activity:', pre_activity, ' ', ground_truth_activity)
            standing_motion_transition_occur_cnt += 1
            print('standing_motion_transition_occur_cnt:', standing_motion_transition_occur_cnt)
            standing_motion_transition_occur_flag = True
        ...
        if rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.Robot_audio_WMU_vision or rl_env_ascc_privacy.RL_ACTION_DICT[action] == rl_env_ascc_privacy.WMU_fusion:
        ...
        if DEBUG:
            ...
            print("Env weights: w_acc:", w_accuracy, " w_energy:", w_energy, " w_privacy:", w_privacy)
            print("Env truth activity:", ground_truth_activity)
            print("predicted_activity:", predicted_activity)
            print('Env Running (after step):', cur_time_str, " evn.runing:", env.get_running_time()) 
            print('motion_transition_:', motion_transition_occur_flag)
        ...
        # p_current_activity_duration_feature = activity_duration_feature_extractor(cur_activity, p_activity_end)
        ...
        print("t_transition_feature:", t_transition_feature)  # 0 1 0, walking , 1 0 0, standing

#         in transition feature extractor: sitting  , sitting  feature: [1 0 0 0]
# in transition feature extractor: standing  , standing  feature: [1 0 0 0]
# in transition feature extractor: walking  , walking  feature: [1 0 0 0]



# in transition feature extractor: walking  , sitting  feature: [0 1 0 0]
# in transition feature extractor: standing  , sitting  feature: [0 0 1 0]
# in transition feature extractor: sitting  , standing  feature: [0 0 0 1]
        #print("t_transition_feature:", list(t_transition_feature))
        #if motion_transition_occur_flag == True:
        # TODO: how to remember the transition states to retrain the model, this kind of information is in shortage
        if t_transition_feature[1] == 1 or t_transition_feature[2] == 1 or t_transition_feature[3] == 1:
            ...
            if t_transition_feature[2] == 1 or t_transition_feature[3] == 1:
                agent.remember_transition_sit_stand(state, action, reward, next_state, env.done)
        ...
        if rember_cnt >= batch_size:
            ...
            print("len mem tra:", len_mem_tra)
            if len_mem > batch_size and len_mem_tra > batch_size:
                #agent.replay(batch_size)
                # if TRAINING_FOR_ALL:
                agent.replay2(batch_size)  # comment
                agent.replay2(batch_size, transition=True)
            else:
                #agent.replay(len_mem-1)
                agent.replay2(len(agent.memory))  # comment
    ...
    print("env.need_recollect_data_cnt:", env.need_recollect_data_cnt)
    ...
    total_privacy_level1_times.append(env.privacy_occur_cnt_level1)
    total_privacy_level2_times.append(env.privacy_occur_cnt_level2)

    
    total_privacy_level1_robot_vision_times.append(env.privacy_occur_cnt_level1_robot_vision)
    total_privacy_level1_robot_sound_times.append(env.privacy_occur_cnt_level1_robot_sound)
    total_privacy_level1_wmu_sound_times.append(env.privacy_occur_cnt_level1_wmu_sound)

    total_privacy_level2_robot_vision_times.append(env.privacy_occur_cnt_level2_robot_vision)
    total_privacy_level2_robot_sound_times.append(env.privacy_occur_cnt_level2_robot_sound)
    total_privacy_level2_wmu_sound_times.append(env.privacy_occur_cnt_level2_wmu_sound)
    ...
    print("total_privacy_level1_times:", total_privacy_level1_times)
    print("total_privacy_level2_times:", total_privacy_level2_times)
    print("total_privacy_level1_robot_vision_times:", total_privacy_level1_robot_vision_times)
    print("total_privacy_level1_robot_sound_times:", total_privacy_level1_robot_sound_times)
    print("total_privacy_level1_wmu_sound_times:", total_privacy_level1_wmu_sound_times)
    print("total_privacy_level2_robot_vision_times:", total_privacy_level2_robot_vision_times)
    print("total_privacy_level2_robot_sound_times:", total_privacy_level2_robot_sound_times)
    print("total_privacy_level2_wmu_sound_times:", total_privacy_level2_wmu_sound_times)
